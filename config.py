...
MIN_SPREAD = 3  # 🎯 МІНІМАЛЬНИЙ СПРЕД: 1.5% як просить користувач
...
TAKE_PROFIT_PCT = 20.0  # 🎯 ВИПРАВЛЕНО: Закривати позицію при +10% прибутку
STOP_LOSS_PCT = 70.0  # 🛡️ ВИПРАВЛЕНО: Стоп-лосс при -10% збитку
...
MONITOR_INTERVAL_SEC = 10  # ⚡ ШВИДКИЙ МОНІТОРИНГ: перевірка позицій кожні 20 сек
